...
JuMP.set_time_limit_sec(opt_model, 120.0)
...
# uk_ωs = @variable(opt_model, [1:3])
# uk_αs = @variable(opt_model, [1:3])
# uk_ρs = @variable(opt_model, [1:3])
